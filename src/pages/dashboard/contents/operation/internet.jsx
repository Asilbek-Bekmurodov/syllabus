  ...
  return (
    <div>
      <h1 className={cls.title}>Internet  section </h1>
                <p style="line-height: 1.295; text-indent: 21.3pt; margin-top: 0pt; margin-bottom: 8pt;"><strong><span style="font-size: 13pt; font-family: Calibri, sans-serif; color: #000000;">Qo&lsquo;shimcha adabiyotlar havolari</span></strong></p>
