...
function AboutCourseOperation() {
  return (
    <div>
      ...
      <p style="line-height: 1.8; text-align: justify; margin-top: 0pt; margin-bottom: 0pt;"><strong><span style="font-size: 13pt; font-family: 'Times New Roman'; color: #000000;">FAN TO&lsquo;GʻRISIDA MA&rsquo;LUMOT</span></strong></p>
